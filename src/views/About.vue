<template>
  <div class="about ">
    <div class="container my-4">
      <div class="row">
        <div class="col-lg-6">
          <img class="img-fluid rounded mb-4" src="@/assets/sonos.png" alt="">
        </div>
        ...
        <section class="col-lg-6">
          ...
          <div class="card text-center">
            <div class="card-body">
              <h4 class="card-title">I Gusti Bagus A</h4>
              <h6 class="card-subtitle mb-2 text-muted">Software Engineer x Nuclear Engineer</h6>
